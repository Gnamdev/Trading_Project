...
// 2. FETCH_COIN_MARKET_CHART
export const FETCH_COIN_MARKET_CHART_REQUEST = "FETCH_COIN_MARKET_CHART_REQUEST";
export const FETCH_COIN_MARKET_CHART_SUCCESS = "FETCH_COIN_MARKET_CHART_SUCCESS";
export const FETCH_COIN_MARKET_CHART_FAILURE = "FETCH_COIN_MARKET_CHART_FAILURE";
